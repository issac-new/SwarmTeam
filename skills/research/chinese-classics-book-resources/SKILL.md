...
> 识典古籍平台工程知识（sitemap 全量索引 / SSR 检索通行名+底本名双试 / argus 风控规避 /
> ID 段位规律 / 合规红线）已独立成 skill：`shidianguji-classics-access` —
> load it for any shidianguji.com access work; this skill stays on K12 book-catalog duty.
