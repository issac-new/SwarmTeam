...
1. **terminal 命令命中 HumanGate-HIGH 候选**（见 `_shared/banned-command-prefixes.md`）
...
| 机制 | 关系 | 说明 |
|---|---|---|
| `banned-command-prefixes.md` | 触发源 | Guardian 的输入之一 |
...
| `task-contract-guard.md` | 复用 | 三行控制头格式复用 |
