...
documentation ("scan for sk-f9d"). The generic 20+ char pattern misses these
because the prefix is short. A targeted second pass is needed:

```python
targeted_patterns = [
    re.compile(r'sk-f9d[a-zA-Z0-9]*'),
    re.compile(r'sk-ezi[a-zA-Z0-9]*'),
    re.compile(r'sk-eGx[a-zA-Z0-9]*'),
    re.compile(r'gho_pW[a-zA-Z0-9]*'),
    re.compile(r'syt_dGVz[a-zA-Z0-9]*'),
    re.compile(r'desk-12fe8aa6[a-zA-Z0-9]*'),
    re.compile(r'm0-18i0[a-zA-Z0-9]*'),
    # Also catch truncated forms: sk-f9d...8956
...
real_prefixes = [
    r'sk-f9d', r'sk-ezi', r'sk-eGx',     # LLM provider keys
    r'gho_pW',                             # GitHub tokens
    r'syt_dGVz',                           # Matrix tokens
    r'desk-12fe8aa6',                      # API server keys
    r'm0-18i0',                            # Mem0 keys
]
