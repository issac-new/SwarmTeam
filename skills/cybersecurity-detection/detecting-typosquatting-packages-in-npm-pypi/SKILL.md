...
- T1554
---
> ⚠️ **DEPRECATED**: This skill is superseded by `detecting-typosquatting-packages` 
> which covers npm + PyPI + crates.io with additional tools (typomania, OSSGadget, pypi-scan).
> This skill is kept for backward compatibility but will be removed in a future cleanup.
> Use `skill_view('detecting-typosquatting-packages')` instead.
