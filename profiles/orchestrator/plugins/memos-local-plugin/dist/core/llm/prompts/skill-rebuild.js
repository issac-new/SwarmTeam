...
export const SKILL_REBUILD_PROMPT = {
    id: "skill.rebuild",
    version: 3,
    description: "Update an existing skill from new evidence while preserving stable identity and controlling rewrite scope.",
...
//# sourceMappingURL=skill-rebuild.js.map