    ...
    while (attempt <= maxRetries) {
        ...
        try {
            ...
            if (!resp.ok) {
                ...
                throw new MemosError(ERROR_CODES.EMBEDDING_UNAVAILABLE, `HTTP ${resp.status} from ${opts.provider}`, { provider: opts.provider, url: opts.url, status: resp.status, body: text });
            }
