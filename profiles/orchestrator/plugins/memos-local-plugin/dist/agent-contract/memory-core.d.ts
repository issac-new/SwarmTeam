...
export interface MemoryCore {
    ...
    reconcileEpisodeId(sessionId: SessionId, candidate?: EpisodeId): EpisodeId | undefined;
    ...
    getTrace(id: string, namespace?: RuntimeNamespace, opts?: {
     ...
     */
    deleteTraces(ids: readonly string[], opts?: {
        includeAllNamespaces?: boolean;
    }): Promise<{
        deleted: number;
    }>;
