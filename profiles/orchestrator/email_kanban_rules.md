...
#   - 邮箱地址: your-bot@example.com (agently-cli)
#   - 邮箱地址: your@example.com (IMAP channel, gateway 原生 adapter)
#   - 定时检查: cron job 已暂停
...
| 4 chat_id | 会话标识 | 收件人邮箱地址（`your-bot@example.com` 或 `your@example.com`） |
...
| 场景 | Tenant 值 |
|------|-----------|
| agently-cli 邮件 | `张三:项目报告:zhangsan@example.com:your-bot@example.com:msg_xxx:email` |
| IMAP channel 邮件 | `李四:漏洞报告:lisi@security.com:your@example.com:42:email` |
...
### 5.1 your@example.com (IMAP Channel)
...
### 5.2 your-bot@example.com (agently-cli)
...
*适用 profile: orchestrator*
*邮箱地址: your@example.com (IMAP) + your-bot@example.com (agently-cli)*
