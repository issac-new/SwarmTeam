...
#   - 邮箱地址: your-agently@email.com (agently-cli)
...
| 4 chat_id | 会话标识 | 收件人邮箱地址（`your-agently@email.com` 或 `your@email.com`） |
...
| 场景 | Tenant 值 |
|------|-----------|
| agently-cli 邮件 | `张三:项目报告:zhangsan@example.com:your-agently@email.com:msg_xxx:email` |
...
### 5.2 your-agently@email.com (agently-cli)
...
*适用 profile: orchestrator*
*邮箱地址: your@email.com (IMAP) + your-agently@email.com (agently-cli)*
