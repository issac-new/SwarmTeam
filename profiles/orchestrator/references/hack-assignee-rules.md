...
| ~~C2/命令控制~~ `hack-c2` | 归档（2026-08-18，非活跃）——原职责 C2 基础设施/持久化划归 hack-exploit 的 c2-infra 能力域 |
| ~~武器/载荷~~ `hack-weapons` | 归档（2026-08-18，非活跃）——原职责 payload/钓鱼模板划归 hack-exploit 的 red-team 能力域 |
