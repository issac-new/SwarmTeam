---
id: KB-CANDIDATE-MATRIX-PEERS-001
type: knowledge-candidate
domain: hermes-cluster
status: OFFICIAL          # 已是事实台账，从 CANDIDATE 转 OFFICIAL
sourceType: official
owner: orchestrator
version: 1
...
tags:
  ...
  - account-ledger
anchors:
  - MATRIX_PEERS:registry
  - MATRIX_BLACKLIST:configuration
---

# Matrix 对端账号台账（matrix-peers）

> 维护人：图爸 / orchestrator
> 原始 ADR 日期：2026-08-20
> 迁移日期：2026-08-25（从 `_shared/decisions/matrix-peers.md` 升级到 `_shared/knowledge/candidate/`）
...
- 终止规则：`_shared/01-scheduling-bus/matrix-collaboration-termination.md`
- 跨机编排：`orchestrator/orchestrator_rules.md §0.8`

## 变更历史

| 版本 | 日期 | 变更内容 | 变更人 |
|---|---|---|---|
| 1 | 2026-08-20 | 初版 ADR | orchestrator |
| 2 | 2026-08-25 | 升级为 KB candidate（含 YAML front matter + sourceType/confidence/stability 元数据）| orchestrator |