...
key_pattern = re.compile(
    ...
    r'["\']?(?:sk-|gho_|syt_|m0-|desk-|REDACTED|REDACTED)[^\s"\']+',
    re.IGNORECASE
)
...
real_prefixes = [
    r'sk-REDACTED',    # DeepSeek
    r'sk-REDACTED',    # SiliconFlow
    r'sk-REDACTED',    # Damoxing
    r'sk-REDACTED',    # Kimi
    r'sk-REDACTED',    # Cherry
    r'gho_REDACTED',    # GitHub Copilot
    r'syt_REDACTED',  # Matrix
    r'REDACTED',  # Gateway token
    r'REDACTED',  # ModelScope key
    r'REDACTED',  # Email password
    r'm0-REDACTED',       # Mem0 key
    r'desk-REDACTED',     # API server key
]
