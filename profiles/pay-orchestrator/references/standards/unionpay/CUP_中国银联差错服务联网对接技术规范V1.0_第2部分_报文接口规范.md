# 中国银联差错服务联网对接技术规范V1.0 第2部分 报文接口规范
> 来源: 银联规范 2015-12 存档 | 92页 | 提取: 2026-09-03
...
3.3.1 否认声明信息格式（RptFraudInfType）  
序号 
报文要素 
XML tag 
属性 
...
C0：对于退单交易原因码4802、4803、4810、4514、4515、4562，必须提交持卡人
身份信息，具体规则以《第四卷》为准。 
C1：对于某些退单交易原因码，必须提交凭证信息，具体规则以《第四卷》为准。 
C2：使用4515 和4810 原因码进行退单时，增加发卡机构声明信息报送。 
C3: 对于某些退单交易原因码，必须提交原因子码，具体规则以《第四卷》为准。 
6.2.2.1.4 发起再请款报文格式 
表7 再请款交易报文格式说明
...
取凭证报文中凭证文件的格式（MTOM或Base64）方式。两种类型（VouDtlQrMsg或
...
参考文献 
[1] 中国银联股份有限公司：《中国银联银行卡交换系统技术规范V2.1》 
